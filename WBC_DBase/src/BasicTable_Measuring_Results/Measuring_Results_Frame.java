...
public class Measuring_Results_Frame extends JFrame {
...
private JProgressBar progressBar;
	...
	public Measuring_Results_Frame(ActionIcone round) {
		...
		Measuring_Results_Metods.setDataTable(null);
		Measuring_Results_Metods.ActionListener_Btn_ReadMeasur( btn_SearchMeasur,  textArea,  
												 infoPanel, tablePane,  panel_AllSaerch,  scrollPane, textEGN, txtStartDate, txtEndDate, btnBackToTable, progressBar);
		
		Measuring_Results_Metods.ActionListenerBtnBackToTable(btnBackToTable, textArea, tablePane,
									panel_AllSaerch, scrollPane, textFieldGodina);
		
		Measuring_Results_Metods.ActionListener_Btn_Export(btn_Export, save_Panel, save_Panel);
		
		Measuring_Results_Metods.ActionListenerChengePanelSizeByFrameSize(this, tablePane, infoPanel);
		
		
		Measuring_Results_Metods.ActionListenerSetDateByDatePicker(txtStartDate, btn_SearchMeasur);
		Measuring_Results_Metods.ActionListenerSetDateByDatePicker(txtEndDate, btn_SearchMeasur);
	...
	private JPanel panel_2() {
		...
		lbl_EGN = new JLabel(referencePerson_EGN);
		lbl_EGN.setSize(new Dimension(120, 20));
		lbl_EGN.setPreferredSize(new Dimension(102, 15));
		lbl_EGN.setMinimumSize(new Dimension(120, 20));
	...
	private JPanel panel_2A() {
		...
		textEGN.setPreferredSize(new Dimension(10, 20));
		textEGN.setColumns(10);
		panel2A.add(textEGN);
		
		lblNewLabel = new JLabel("");
		lblNewLabel.setPreferredSize(new Dimension(13, 15));
		panel2A.add(lblNewLabel);
