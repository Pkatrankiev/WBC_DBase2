	...
	public static void ActionListener_Btn_StartGenerateTable_PersonStatus(JButton btn_StartGenerateTable,
		...
		btn_StartGenerateTable.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JTextField textField_EGN = PersonReference_PersonStatus_Frame.getTextEGN();
				...
				Person person = PersonDAO.getValuePersonByEGN(egn);
				    if(person != null || egn.isEmpty() || OptionDialog("Не намирам служител с ЕГН: "+ egn)) {
				    	...
				    	pbwpr = new ProgressBarWorkerPersonReference(textField_Year, person, progressBar, panel_AllSaerch, tablePane,
	...
	public static void ActionListener_Btn_ExportToExcel(JButton btn_Export, JPanel tablePane) {
		...
		btn_Export.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonReferenceExportToExcell.btnExportTableToExcell(volue, columName, tablePane, "PersonReference");
